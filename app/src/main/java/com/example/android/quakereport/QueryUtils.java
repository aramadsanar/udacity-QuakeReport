...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String data) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                float magnitude = Float.parseFloat(feature.getString("mag").toString());
                String place = feature.getString("place");
                long timeRaw = feature.getLong("time");
                String url = feature.getString("url");

                earthquakes.add(new Earthquake(magnitude, place, timeRaw, url));
            }
